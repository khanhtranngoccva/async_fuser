...
mod op {
    ...
    use crate::ll::argument::ArgumentIterator;
    use crate::ll::flags::access_flags::AccessFlags;
    use crate::ll::flags::bsd_file_flags::BsdFileFlags;
    use crate::ll::flags::copy_file_range_flags::CopyFileRangeFlags;
    ...
    use crate::ll::flags::open_flags::OpenFlags;
    ...
    impl Open<'_> {
        pub(crate) fn flags(&self) -> OpenFlags {
            OpenFlags::from_bits_retain(self.arg.flags)
        }
    }
